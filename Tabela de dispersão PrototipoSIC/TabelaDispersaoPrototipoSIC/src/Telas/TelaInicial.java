...
public class TelaInicial extends javax.swing.JFrame {
    ...
    public TelaInicial(TabelaHash tabelar) {
        initComponents();        
    ...
    private void btnImportarJsonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportarJsonActionPerformed
        ...
        if (tabela == null) {
            tabela = new TabelaHash();  // Cria uma nova tabela se não existir
        }
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            tabela = jsonImporter.importarCidadaosDeJson(caminhoDoArquivo, tabela);            
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaInicial(tabela).setVisible(true);
            }
        });
    }

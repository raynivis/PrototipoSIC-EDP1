...
public class GerenciadorDeDados {
    ...
    public static void verificarExistenciaArquivo(EstruturaRBT arvoreRB) {
        ...
        if (arquivo.exists()) {
            ...
            tempo.iniciar();
            dados.importarCidadaosDeJsonRapido(CAMINHO_DO_ARQUIVO, arvoreRB);
            tempo.finalizar();
    ...
    public void salvarCidadaos(EstruturaRBT arvoreRB) {
        JSONArray listaCidadaos = new JSONArray();
        
        arvoreRB.preOrdem((noAVL) -> {

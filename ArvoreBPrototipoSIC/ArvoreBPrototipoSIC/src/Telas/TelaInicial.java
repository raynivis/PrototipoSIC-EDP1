...
public class TelaInicial extends javax.swing.JFrame {
    ...
    public TelaInicial(ArvoreB arvoreB) {
        initComponents();        
    ...
    private void btnImportarJsonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportarJsonActionPerformed
        ...
        if (arvoreB == null) {
            arvoreB = new ArvoreB(5);  // Cria uma nova lista se não existir
        }
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            arvoreB = jsonImporter.importarCidadaosDeJson(caminhoDoArquivo, 5);

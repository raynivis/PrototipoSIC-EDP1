...
public class TelaEscolhas extends javax.swing.JFrame {
     ...
     */
    public TelaEscolhas(EstruturaRBT arvoreRB) {
        initComponents();
    ...
    private void btnBuscarCpfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarCpfActionPerformed
        setVisible(false);
        new TelaBuscarCPF(arvoreRB).setVisible(true);        // TODO add your handling code here:
    }//GEN-LAST:event_btnBuscarCpfActionPerformed

    private void btnGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarRelatorioActionPerformed
        setVisible(false);
        new TelaRelatorio(arvoreRB).setVisible(true);  // TODO add your handling code here:

...
public class TelaInicial extends javax.swing.JFrame {
    ...
    public TelaInicial(EstruturaRBT arvoreRB) {
        initComponents();        
    ...
    private void btnImportarJsonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportarJsonActionPerformed
        ...
        if (arvoreRB == null) {
            arvoreRB = new EstruturaRBT();  // Cria uma nova lista se não existir
        }
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            arvoreRB = jsonImporter.importarCidadaosDeJson(caminhoDoArquivo, arvoreRB);

...
public class JsonImporter {
        ...
        public EstruturaRBT importarCidadaosDeJson(String arquivoJson, EstruturaRBT arvoreRB) {
            ...
            try {
                ...
                for (Object c : cidadaosJson) {
                    ...
                    arvoreRB.inserirRBT(novoCidadao);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        public void importarCidadaosDeJsonRapido(String arquivoJson, EstruturaRBT arvoreRB) {
            JSONParser parser = new JSONParser();
            try {
                Object obj = parser.parse(new FileReader(arquivoJson));
                ...
                for (Object c : cidadaosJson) {
                    ...
                    if (novoCidadao != null) {
                        ...
                        arvoreRB.inserirRBTRapido(novoCidadao);
                    }
                }
                arvoreRB.qtdCidadao();
            } catch (Exception e) {
